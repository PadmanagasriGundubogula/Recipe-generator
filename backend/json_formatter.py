...
class JsonFormatter:
    ...
    def process(self):
        for filename in os.listdir(self.input_folder):
            ...
            output_filename = f"{output_filename}-graph.json"
...
if __name__ == "__main__":
    input_folder = r"utils/input_text_files"
    output_folder = r"utils/graph_json_files"
    log_folder = r"utils/usr_error_logs"
